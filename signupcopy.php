    ...
    else
    {
        ...
        {           
            ...
            $message = "                    
                        Hello $uname,
                        <br /><br />
                        Welcome To E-Square Technology Ltd Company<br/>
                        To complete your registration and activate your account  please , just click following link<br/>
                        <br /><br />
                        <a href='http://esquretchltd.000webhostapp.com/verify.php?id=$id&code=$code'>Click Here to Activate :)</a>
                        <br />
                        Thanks,";
